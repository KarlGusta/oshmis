  ...
  <body  class=" border-top-wide border-primary d-flex flex-column">
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <form class="card card-md" action="signupAction.jsp" method="post" id="signupForm">
          <div class="card-body">
              <%
            ...
            <button type="submit" value="signup" class="btn btn-primary w-100">Create new account</button>
            </div>
          </div>
        </form>
