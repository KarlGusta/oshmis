...
<html lang="en">
  ...
  <body >
            ...
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="collect-cash-payments.jsp">Collect cash payment</a>
                      <a class="dropdown-item" href="collect-insurance-payments.jsp">Collect Insurance payment</a>
                    </div>
                  </div>
                </div>
              </li>
							...
							<form class="card card-md" action="add-a-patient-action.jsp" method="post">
								...
								<!-- Success or error message -->
                                    ...
                                    <div class="mb-3">
                                           ...
                                           <input type="text" class="form-control" name="nextOfKinPhoneNumber" placeholder="Enter next of kin phone number">
                                    </div>
					                <div class="mb-3">
										<div class="form-label">Mode of payment</div>
										<select class="form-select" name="modeOfPayment" id="modeOfPayment" onChange="checkIfInsuranceSelected(this);">
									...
									<div class="form-footer">
										<button type="submit" class="btn btn-primary w-100">Register a patient</button>
									</div>
								</div>
							</form>
						</div>
    ...
    <!-- If they select cash, leave it. If they select insurance, display the insurance input box -->
    <script>
      function checkIfInsuranceSelected(that){
        if(that.value == "Insurance"){
